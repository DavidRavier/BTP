...
export default function Advice() {
    return (
        <>
<h2 className="text-dark font-restora text-justify mb-4 mt-16 ml-18">Nos conseils</h2>
        ...
        <button className="bg-secondary px-4 mr-6 mb-8">05 34 51 57 91</button>
          ...
          <Image 
            src="/Homepage_advice1.png"
              ...
              height={12}
          />
          <p className="text-dark font-restora text-xl mb-4">UN PETIT COUP DE PELLE?</p>
          <ListItemIcon>
            <West />
            <East />
          </ListItemIcon>
      ...
      <button className="text-dark text-left my-4 ml-18">EN SAVOIR PLUS</button>
        </>
    )
}
